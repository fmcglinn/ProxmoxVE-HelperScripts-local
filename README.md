...
<div style="border: 2px solid #d1d5db; padding: 20px; border-radius: 8px; background-color: #f9fafb;">
  ...
  <p align="center">
    ...
    <a href="https://github.com/fmcglinn/ProxmoxVE-HelperScripts-local/blob/main/.github/CONTRIBUTOR_AND_GUIDES/CONTRIBUTING.md">
      <img src="https://img.shields.io/badge/Contribute-ff4785?style=for-the-badge&logo=git&logoColor=white" alt="Contribute" />
    </a> 
    <a href="https://github.com/fmcglinn/ProxmoxVE-HelperScripts-local/blob/main/.github/CONTRIBUTOR_AND_GUIDES/USER_SUBMITTED_GUIDES.md">
      <img src="https://img.shields.io/badge/Guides-0077b5?style=for-the-badge&logo=read-the-docs&logoColor=white" alt="Guides" />
    </a> 
    <a href="https://github.com/fmcglinn/ProxmoxVE-HelperScripts-local/blob/main/CHANGELOG.md">
...
- **GitHub Discussions**: [Ask questions or report issues](https://github.com/fmcglinn/ProxmoxVE-HelperScripts-local/discussions).

## 🤝 Report a Bug or Feature Request

If you encounter any issues or have suggestions for improvement, file a new issue on our [GitHub issues page](https://github.com/fmcglinn/ProxmoxVE-HelperScripts-local/issues). You can also submit pull requests with solutions or enhancements!

---

## ⭐ Star History

<a href="https://star-history.com/#fmcglinn/ProxmoxVE-HelperScripts-local&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=fmcglinn/ProxmoxVE-HelperScripts-local&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=fmcglinn/ProxmoxVE-HelperScripts-local&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=fmcglinn/ProxmoxVE-HelperScripts-local&type=Date" />
 </picture>
</a>
