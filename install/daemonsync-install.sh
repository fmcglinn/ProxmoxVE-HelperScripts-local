...
curl -fsSL "https://raw.githubusercontent.com/fmcglinn/ProxmoxVE-HelperScripts-local/main/tools/addon/daemonsync_2.2.0.0059_amd64.deb" -o "daemonsync_2.2.0.0059_amd64.deb"
